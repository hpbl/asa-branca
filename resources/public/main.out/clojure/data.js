...
return cljs.core.reduce.call(null,(function (result,p__25762){
var vec__25763 = p__25762;
var k = cljs.core.nth.call(null,vec__25763,(0),null);
var v = cljs.core.nth.call(null,vec__25763,(1),null);
...
var vec__25766 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__25766,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__25766,(1),null);
var ab = cljs.core.nth.call(null,vec__25766,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_25772 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_25772.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_25773 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_25773.call(null,a,b);
}
});
...
return (function (){var G__25777 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25777__$1)].join('')));
