...
var G__24362 = devtools.prefs.pref.call(null,v);
v = G__24362;
continue;
} else {
return v;
...
}catch (e24365){var _e__23373__auto__ = e24365;
return false;
}})();
...
}catch (e24369){var _e__23373__auto__ = e24369;
return false;
}})();
...
}catch (e24371){var _e__23373__auto__ = e24371;
return false;
}}
}
});
...
var vec__24373 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__24373,(0),null);
var name = cljs.core.nth.call(null,vec__24373,(1),null);
...
return cljs.core.some.call(null,(function (p1__24376_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__24376_SHARP_);
}),template);
});
