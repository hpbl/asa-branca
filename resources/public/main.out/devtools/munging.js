...
var o24257 = temp__5733__auto__;
var temp__5733__auto____$1 = (o24257["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o24258 = temp__5733__auto____$1;
...
var o__23366__auto__ = f;
return (o__23366__auto__["toString"]).call(o__23366__auto__);
} else {
return "";
}
}catch (e24259){var _ = e24259;
return "";
}});
...
try{var o__23366__auto___24261 = t;
(o__23366__auto___24261["cljs$lang$ctorPrWriter"]).call(o__23366__auto___24261,t,writer);
}catch (e24260){var __24262 = e24260;
}
...
var char_code = (function (){var o__23366__auto__ = (new String(char$));
return (o__23366__auto__["charCodeAt"]).call(o__23366__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23366__auto__ = String;
return (o__23366__auto__["fromCharCode"]).call(o__23366__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24263 = num_code;
switch (G__24263) {
case (1):
return (185);
...
var o__23366__auto__ = String;
return (o__23366__auto__["fromCharCode"]).call(o__23366__auto__,superscript_code);
});
/**
...
}catch (e24265){var _e__23373__auto__ = e24265;
return false;
}})())){
...
var vec__24266 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24266,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o24269 = temp__5733__auto__;
var temp__5733__auto____$1 = (o24269["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o24270 = temp__5733__auto____$1;
return (o24270["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___24277 = arguments.length;
var i__4737__auto___24278 = (0);
while(true){
if((i__4737__auto___24278 < len__4736__auto___24277)){
args__4742__auto__.push((arguments[i__4737__auto___24278]));

var G__24279 = (i__4737__auto___24278 + (1));
i__4737__auto___24278 = G__24279;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24273){
var vec__24274 = p__24273;
var ns_detector = cljs.core.nth.call(null,vec__24274,(0),null);
...
var G__24280 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24281 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24280;
remaining_tokens = G__24281;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24271){
...
var vec__24285 = cljs.core.split_with.call(null,(function (p1__24284_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24284_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24285,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24285,(1),null);
...
var vec__24291 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24291,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24291,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24294 = cljs.core.rest.call(null,remaining_tokens);
var G__24295 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24294;
name_tokens = G__24295;
continue;
} else {
...
var vec__24298 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24298,(0),null);
var arity = cljs.core.nth.call(null,vec__24298,(1),null);
var vec__24301 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24301,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24301,(1),null);
var vec__24304 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24304,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24304,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24304,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24304,(3),null);
...
var vec__24310 = result;
var munged_ns = cljs.core.nth.call(null,vec__24310,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24310,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24310,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24310,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24310,(4),null);
var arity = cljs.core.nth.call(null,vec__24310,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__24314 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__24314,(0),null);
var args = cljs.core.nth.call(null,vec__24314,(1),null);
var vec__24317 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24317,(0),null);
var name = cljs.core.nth.call(null,vec__24317,(1),null);
...
var G__24320 = (arity + (1));
var G__24321 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24322){
var vec__24323 = p__24322;
var arity = cljs.core.nth.call(null,vec__24323,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24323,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__24326_SHARP_){
return cljs.core.get.call(null,arities,p1__24326_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__24327_SHARP_){
return cljs.core.drop.call(null,(2),p1__24327_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24330){
var vec__24331 = p__24330;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24331,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24328){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24339__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24339__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24339__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24339__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24340 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24340,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24340,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24340,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24340,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24340,(4),null);
var arity = cljs.core.nth.call(null,vec__24340,(5),null);
...
var o__23366__auto__ = f;
return (o__23366__auto__["getBasis"]).call(o__23366__auto__);
});
/**
...
}catch (e24344){var _e__23373__auto__ = e24344;
...
var G__24345 = (obj[cljs.core.first.call(null,path)]);
var G__24346 = cljs.core.rest.call(null,path);
obj = G__24345;
path = G__24346;
continue;
} else {
...
var _STAR_ = (function (accum,p__24347){
var vec__24348 = p__24347;
var bit = cljs.core.nth.call(null,vec__24348,(0),null);
var protocol = cljs.core.nth.call(null,vec__24348,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24351){
var vec__24352 = p__24351;
var ns = cljs.core.nth.call(null,vec__24352,(0),null);
var name = cljs.core.nth.call(null,vec__24352,(1),null);
var selector = cljs.core.nth.call(null,vec__24352,(2),null);
...
var post_process = (function (p__24356){
var vec__24357 = p__24356;
var munged_name = cljs.core.nth.call(null,vec__24357,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24357,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__24355_SHARP_){
return (obj[cljs.core.first.call(null,p1__24355_SHARP_)]);
}),sorted_matches);
